...
icons10-angle-right Основные навыки:
Frontend: React, Redux, TypeScript, JavaScript, HTML, CSS

icons10-angle-right Инструменты: RTK, RTK-Query, API

icons10-angle-right Обучение: Курсы в Яндекс.Практикуме, Кате

icons10-angle-right Спорт: Мастер спорта по академической гребле  
